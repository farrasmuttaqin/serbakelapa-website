            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-8">
                    <div class="blog-posts-area">
                        <?php foreach($events as $paper) { $tampungXYZ ++;?>
                        <!-- Post Details Area -->
                        <div class="single-post-details-area">
                            <div class="post-content" style="text-align: justify;"> 
                                ...
                                <div class="post-thumbnail mb-30" align="center">
                                    <img style="height:350px;width:320px;" src="<?php echo base_url(); ?>assets/img/events/<?php echo $paper->thumbnail; ?>" alt="">
                                </div>
                                <?php echo $paper->isi; ?>
                            </div>
                        </div>
                            ...
                            echo "<div class='leave-comment-area clearfix'>
                                    <div class='comment-form'>
                                        ...
                                        <div class='contact-form-area'>
                                            <!-- Comment Form -->
                                            <form action='".base_url()."events/inputComment/' method='post' ";?> onsubmit="return confirm('Komen yang anda berikan tidak bisa di hapus, yakin beri komen ?');" <?php echo ">
                                                <div class='row'>
                                                    <div class='col-12'>
                        ...
                        <div class="single-widget-area">
                            ...
                            <div class="single-latest-post d-flex align-items-center">
                                <div class="post-thumb">
                                    <img src="<?php echo base_url(); ?>assets/img/events/<?php echo $post->thumbnail; ?>" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="<?php echo base_url('events/detail/'.$post->id_paper.'/'); ?>" class="post-title">
                                        <h6><?php echo $post->judul; ?></h6>
                                    </a>
                                    <a href="<?php echo base_url('events/detail/'.$post->id_paper.'/'); ?>" class="post-date"><?php echo $post->tanggal_publish; ?></a>
                                </div>
                            </div>
                            <?php } ?>
                        </div>
