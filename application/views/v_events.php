...
<head>
    <title>Events | Serba Kelapa</title>
    <meta name="description" content="Full Events"/>
    <meta name="keywords" content="events, serba kelapa"/>
    <?php
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><i class="fa fa-book"></i> Events</li>
                        </ol>
                    </nav>
                </div>
            </div>
	...
	<section class="bgwhite p-t-60">
		<div class="container">
			<div class="row" id="pagin">
                ...
                <?php foreach($events as $paper){ ?>
			    <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-blog-post mb-100">
                        <div class="post-thumbnail mb-30 item-blog-img pos-relative dis-block">
                            <a href="<?php echo base_url('events/detail/'.$paper->id_paper.'/'); ?>"><img src="<?php echo base_url('assets/img/events/'.$paper->thumbnail); ?>" alt=""></a>
                        </div>
                        <div class="post-content">
                            <a href="<?php echo base_url('events/detail/'.$paper->id_paper.'/'); ?>" class="post-title">
                                <h5><?php echo $paper->judul; ?></h5>
                            </a>
                            <div class="post-meta">
                                <a href="<?php echo base_url('events/detail/'.$paper->id_paper.'/'); ?>"><i class="fa fa-clock-o" aria-hidden="true"></i><?php echo $paper->tanggal_publish; ?></a>
                                <a href="<?php echo base_url('events/detail/'.$paper->id_paper.'/'); ?>"><i class="fa fa-user" aria-hidden="true"></i><?php echo $paper->nama_pembuat; ?></a>
                            </div>
                            <p style="text-align:justify;" class="post-excerpt"><?php $tampung = substr($paper->kalimat_pendek, 0, 200).'...'; echo $tampung; ?></p>
                            <br>
                            <a href="<?php echo base_url('events/detail/'.$paper->id_paper.'/'); ?>" class="btn alazea-btn w-40">
							Read More
						    </a>
                        </div>
                    </div>
