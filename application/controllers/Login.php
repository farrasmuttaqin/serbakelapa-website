...
class Login extends CI_Controller {
	...
	public function changePassword()
	{
		...
		if ($cek>0){
			...
			$this->session->set_flashdata("tampung","10");
			redirect(base_url("login/berhasilUbah"));
		}
	}

	public function berhasilUbah(){
		if ($this->session->flashdata("tampung") == "10"){
			$this->load->view('v_ubahPass');
		}else{
			redirect(base_url('login'));
		}
	...
	public function forgotAction()
	{
		...
		if($cek > 0) {
								...
								<table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%'>
									<tr>
										<td style='padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;'>
											<h1 style='margin: 0 0 10px; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;'>Reset Password</h1>
											<p style='margin: 0 0 10px;'>Reset Password Akun Serba Kelapa anda dengan Menekan Tombol Reset link dibawah</p>
											...
											<table align='center' role='presentation' cellspacing='0' cellpadding='0' border='0' style='margin: auto;'>
												<tr>
													<td class='button-td button-td-primary' style='border-radius: 4px; background: #222222;'>
														<a class='button-a button-a-primary' href='".base_url()."login/forgot/$hash2/$email' style='background: #222222; border: 1px solid #000000; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 4px;'>Reset Password Saya</a>
													</td>
												</tr>
											</table>
											<!-- Button : END -->
			...
			$this->session->set_flashdata("tampungForgot","1");
			redirect(base_url("login"));
		} else {
			$this->session->set_flashdata("tampungForgot","2");
			redirect(base_url("login"));
		}
	}
	...
	public function loginAction()
	{
		...
		if($cek > 0) {
			if ($cekSecond > 0){
				...
				$this->session->set_flashdata("tampungLogin","999");
				$data_userFalse = $this->Login_model->loginCheck("tb_users",$where)->result();
			...
			$this->session->set_flashdata("tampungLogin","99");
			redirect(base_url('login'));
		}
	}
	...
	{	
		...
		if ($this->Login_model->registerCheck($email,$notel)){
			$this->session->set_flashdata("tampungRegister","2");
			redirect(base_url('login'));
		}else{
			$messages = "
									...
									<tr>
										<td style='padding: 0 20px 20px;'>
											...
											<table align='center' role='presentation' cellspacing='0' cellpadding='0' border='0' style='margin: auto;'>
												<tr>
													<td class='button-td button-td-primary' style='border-radius: 4px; background: #222222;'>
														<a class='button-a button-a-primary' href='".base_url()."login/verify/$hash2/$email' style='background: #222222; border: 1px solid #000000; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 4px;'>Centered Primary Button</a>
													</td>
												</tr>
											</table>
											<!-- Button : END -->
			...
			$this->session->set_flashdata("tampungRegister","1");
			redirect(base_url("login"));
		}
	}
	...
	public function sentVerification()
	{
		...
		<!DOCTYPE html>
						...
						<tr>
							<td style='background-color: #ffffff;'>
								<table role='presentation' cellspacing='0' cellpadding='0' border='0' width='100%'>
									<tr>
										<td style='padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;'>
											<h1 style='margin: 0 0 10px; font-size: 25px; line-height: 30px; color: #333333; font-weight: normal;'>Aktifkan Akun</h1>
											<p style='margin: 0 0 10px;'> Aktifkan akun serba kelapa kamu dengan meng-click tombol di bawah ini</p>
									...
									<tr>
										<td style='padding: 0 20px 20px;'>
											...
											<table align='center' role='presentation' cellspacing='0' cellpadding='0' border='0' style='margin: auto;'>
												<tr>
													<td class='button-td button-td-primary' style='border-radius: 4px; background: #222222;'>
														<a class='button-a button-a-primary' href='".base_url()."login/verify/$hashh/$email' style='background: #222222; border: 1px solid #000000; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 4px;'>Aktifkan Akun Saya</a>
													</td>
												</tr>
											</table>
											<!-- Button : END -->
			...
			$this->session->set_flashdata("resent","1");
        	redirect(base_url()."login");
	}
}